...
public final class GCMRegistrar {
    ...
    /**
     * {@link util.GCMBroadcastReceiver} instance used to handle the retry intent.
     *
     * <p>
     ...
     *      {@value util.GCMConstants#PERMISSION_GCM_INTENTS} permission.
     *    <li>The {@link android.content.BroadcastReceiver}(s) handles the 3 GCM intents
     *      ({@value util.GCMConstants#INTENT_FROM_GCM_MESSAGE},
     *      {@value util.GCMConstants#INTENT_FROM_GCM_REGISTRATION_CALLBACK},
     *      and {@value util.GCMConstants#INTENT_FROM_GCM_LIBRARY_RETRY}).
     * </ol>
     ...
     * {@link util.GCMConstants#INTENT_FROM_GCM_REGISTRATION_CALLBACK} intent with
     * either a {@link util.GCMConstants#EXTRA_REGISTRATION_ID} or
     * {@link util.GCMConstants#EXTRA_ERROR}.
     *
     * @param context application context.
     ...
     * <p>
     * The result will be returned as an
     * {@link util.GCMConstants#INTENT_FROM_GCM_REGISTRATION_CALLBACK} intent with an
     * {@link util.GCMConstants#EXTRA_UNREGISTERED} extra.
     */
    ...
    /**
     * Lazy initializes the {@link util.GCMBroadcastReceiver} instance.
     */
